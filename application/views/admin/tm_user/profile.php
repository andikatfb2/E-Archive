								...
								<div class="box-body">
									<table class="table table-striped table-hover">
										...
										<?php foreach ($user_info as $user):?>
											<tr>
												<th><?php echo lang('tm_user_ip_address'); ?></th>
											...
											<tr>
												<th><?php echo lang('tm_user_username'); ?></th>
											...
											<tr>
												<th><?php echo lang('tm_user_created_on'); ?></th>
												<td><?php echo date('d-m-Y', $user->created_on); ?></td>
											</tr>
											<tr>
												<th><?php echo lang('tm_user_last_login'); ?></th>
												<td><?php echo ( ! empty($user->last_login)) ? date('d-m-Y', $user->last_login) : NULL; ?></td>
											</tr>
											<tr>
												<th><?php echo lang('tm_user_status'); ?></th>
												<td><?php echo ($user->active) ? '<span class="label label-success">'.lang('tm_user_active').'</span>' : '<span class="label label-default">'.lang('tm_user_inactive').'</span>'; ?></td>
											</tr>
											<tr>
												<th><?php echo lang('tm_user_company'); ?></th>
												<td><?php echo htmlspecialchars($user->company, ENT_QUOTES, 'UTF-8'); ?></td>
											</tr>
											<tr>
												<th><?php echo lang('tm_user_phone'); ?></th>
