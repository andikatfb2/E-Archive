...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?=active_link_controller('tm_user')?>">
                            <a href="<?php echo site_url('admin/tm_user'); ?>">
                                <i class="fa fa-user"></i> <span><?php echo lang('menu_tm_user'); ?></span>
                            </a>
                        </li>
                       ...
                       <!--  </li> <li class="<?=active_link_controller('Konfigurasi Dokumen')?>">
                            <a href="<?php echo site_url('admin/konfig_dokumen'); ?>">
                                <i class="fa fa-cogs"></i> <span><?php echo lang('menu_konfig_dokumen'); ?></span>
                            </a>
                        </li> -->
