...
1. Unzip the package.
2. Upload the `AdminLTE` folders and files to your server. Normally the index.php file will be at your root.
...
```
4. Create a table named `earsip` and inject the data from the `install/sql/earsip.sql` file.
5. Change if necessary the connection information to your database in the `application/config/database.php` file.

## Demo

https://demo.domprojects.com/AdminLTE/auth/login
...
* [E-Arsip](https://github.com/almasaeed2010/AdminLTE)
